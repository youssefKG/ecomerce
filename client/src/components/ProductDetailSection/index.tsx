      ...
      <div className="flex  flex-col 2xl:col-start-4 lg:col-span-2 row-start-1  justify-center h-full gap-8  ">
        ...
        <div className="flex flex-col gap-5">
          <p className="text-gray-600 font-medium text-sm">
            ...
            dolor sit amet, officia excepteur ex fugiat reprehenderit enim Lorem
            ...
            nostrud ipsum Lorem est aliquip amet voluptate Lorem ipsum dolor sit
            amet, officia excepteur ex fugiat reprehenderit enim labore culpa
            ...
            ipsum Lorem est aliquip amet voluptate labore culpa sint ad nisi
            ...
            aliquip amet voluptate Lorem ipsum dolor sit amet, officia excepteur
            ...
            excepteur officia. Reprehenderit nostrud nostrud ipsum Lorem est
            aliquip amet voluptate reprehenderit enim labore culpa sint ad nisi
            Lorem pariatur mollit ex esse exercitation amet. Nisi anim cupidatat
            excepteur officia. Reprehenderit nostrud nostrud ipsum Lorem est
